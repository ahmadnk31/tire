  ...
  return (
    <div className='container mx-auto px-4 py-8'>
          ...
          <Tabs defaultValue='specifications' className='mt-6'>
            ...
            <TabsContent value='performance' className='pt-4'>
              <div className='grid grid-cols-2 gap-y-3 gap-x-6'>
                <div>
                  <span className='font-medium'>
                    {t("performanceTab.treadPattern")}
                  </span>
                  <p>{product.treadPattern}</p>
                </div>
                <div>
                  <span className='font-medium'>
                    {t("performanceTab.wetGrip")}
                  </span>
                  <p>
                    {t(`performance.ratings.${product.wetGrip}`) ||
                      product.wetGrip}{" "}
                ...
                <div>
                  <span className='font-medium'>
                    {t("performanceTab.fuelEfficiency")}
                  </span>
                  <p>
                    {t(`performance.ratings.${product.fuelEfficiency}`) ||
                      product.fuelEfficiency}{" "}
                ...
                <div>
                  <span className='font-medium'>
                    {t("performanceTab.utqgRating")}
                  </span>
                  <p>
                    {product.treadwear} / {product.traction} /{" "}
                    {product.temperature}
                  </p>
                </div>
                {product.mileageWarranty && (
                  <div>
                    <span className='font-medium'>
                      {t("performanceTab.mileageWarranty")}
                    </span>
                    <p>
                      {product.mileageWarranty.toLocaleString()}{" "}
                      {t("performanceTab.miles")}
                    </p>
                  </div>
                )}
              </div>
            ...
            <TabsContent value='details' className='pt-4'>
              <div className='grid grid-cols-2 gap-y-3 gap-x-6'>
                ...
                <div>
                  <span className='font-medium'>
                    {t("detailsTab.category")}
                  </span>
                  <p>{product.category.name}</p>
                </div>
                <div>
                  <span className='font-medium'>
                    {t("detailsTab.countryOrigin")}
                  </span>
                  <p>{product.countryOfOrigin}</p>
                </div>
                <div>
                  <span className='font-medium'>
                    {t("detailsTab.certifications")}
                  </span>
      ...
      <div className='mt-10'>
        <div>
          {" "}
          {/* Display a few featured reviews directly */}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
              {Array(4)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className='h-60 bg-gray-100 animate-pulse rounded'
                  />
                ))}
            </div>
          }
