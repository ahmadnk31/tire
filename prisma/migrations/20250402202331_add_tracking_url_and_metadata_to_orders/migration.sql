-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'RETAILER');
...
CREATE TABLE "RetailerRequest" (
    ...
    CONSTRAINT "RetailerRequest_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Product" (
    ...
    "sidewallType" TEXT NOT NULL,
    "runFlat" BOOLEAN NOT NULL DEFAULT false,
    "reinforced" BOOLEAN NOT NULL DEFAULT false,
    "treadPattern" TEXT NOT NULL,
    "wetGrip" TEXT NOT NULL,
    "fuelEfficiency" TEXT NOT NULL,
    "noiseLevel" TEXT NOT NULL,
    "snowRating" TEXT NOT NULL,
    "treadwear" INTEGER NOT NULL,
    "traction" TEXT NOT NULL,
    "temperature" TEXT NOT NULL,
    "mileageWarranty" INTEGER,
    "plyRating" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_tireId_key" ON "Product"("tireId");
